const currencies = [
    ...
    , {
        "name": "Belarussian Ruble", "code": "BYN"
    }
    , {
    ...
    , {
        "name": "Uruguay Peso en Unidades Indexadas (URUIURUI)", "code": "UYI"
    }
    , {
